# 🎯 Kişisel Portföy Yönetim Sistemi – ASP.NET Core 6.0 ile Dinamik Web Uygulaması
...
* ✔️ ASP.NET Core 6.0 ile modern ve güçlü bir altyapı
* ✔️ Entity Framework Core ve Code First mimarisiyle veritabanı işlemleri
* ✔️ MSSQL Server entegrasyonu
* ✔️ PartialView ve ViewComponent kullanımıyla modüler ve yeniden kullanılabilir yapı
* ✔️ Bootstrap ve Font Awesome destekli kullanıcı dostu arayüz
* ✔️ Katmanlı mimari yerine sade tek katmanlı bir yapı ile basitlik ve kontrol
...
![Deneyim Görseli](readme-assets/images/deneyim.png)

* ![Deneyim Ekleme Görseli](images/deneyimekle.png)

* ![Deneyim Güncelleme Görseli](images/deneyimgüncelleme.png)
...
* ![Eğitim Görseli](images/eğitim.png)
...
* ![Hakkımda Görseli](images/hakkımda.png)
...
* ![İletişim Görseli](images/iletisim.png)
...
* ![Hizmetlerim Görseli](images/hizmetlerim.png)
...
* ![Referans Görseli](images/referans.png)
...
* ![Projeler Görseli](images/proje.png)
...
* ![Yetenekler Görseli](images/yetenek.png)
...
* ![Mesajlar Görseli](images/mesajlar.png)
...
* ![Medya Görseli](images/sosyalmedya.png)
...
* ![İstatistik Görseli](images/istatistikler.png)

---

## 🧑‍💻 UI Panelinde Öne Çıkanlar

* ![Anasayfa Görseli](images/anasayfa.png)

### 👩‍🏫 Hakkımda

* Tüm bilgiler dinamik olarak çekilir ve görsel tasarımla desteklenir

* ![Hakkımda Görseli](images/hakkımdaui.png)
...
* ![Proje1 Görseli](images/projelerimtümü.png)

* ![Proje2 Görseli](images/projelerim.net.png)

* ![Proje3 Görseli](images/projelerimreact.png)

* ![Proje4 Görseli](images/projelerimjs.png)

### 📊 Hizmetlerim

* Hizmetlerim bölümü dinamik olarak veri tabanı üzerinden çekilmiştir

* ![Hizmetlerim Görseli](images/hizmetlerimui.png)

### 📊 Referanslarım

* Referanslarım bölümü dinamik olarak veri tabanı üzerinden çekilmiştir

* ![Referanslarım Görseli](images/referanslarım.png)
...
* ![iletişim Görseli](images/iletişimui.png)

* ![mesaj Görseli](images/mesajbaşarılı.png)
...
* ![error Görseli](images/error.png)
